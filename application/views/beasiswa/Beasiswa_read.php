            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <div class="card-header">Data Beasiswa
                        ...
                        <a href="<?= base_url('beasiswa/cetak') ?>" target="_blank" class= "btn btn-sm btn-info mr-1 float-right">
                            ...
                            <tbody>
                                ...
                                foreach ($beasiswa as $a) {
                                        ...
                                        if ($this->session->userdata('peran') !='USER') : 
                                            echo "<td>
                                            <a href=".base_url('beasiswa/ubah/' . $a->id)." class='btn btn-info btn-sm'>
                                        <i class='fas fa-edit'></i> Ubah
                                        </a>
                                            <a href=".base_url('beasiswa/hapus/' . $a->id)." class+'btn btn-danger btn-sm'
                                             onclick='return confirm(\"Ingin hapus data ini?\")'><i class='fas fa-trash'></i> Hapus
                                             </a>
                                             </td>";
                                        endif;
                                        echo "</tr>";
