                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" value="<?= $beasiswa_>nama_beasiswa ?>"name="nama_beasiswa" required placeholder+"nama_beasiswa" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-md-2">Tanggal Mulai</label>
                                <div class="col-md-10">
                                    <input type="date" value="<?= $beasiswa_>tanggal_mulai ?> name="tanggal_mulai" required class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-md-2">Tanggal Selesai</label>
                                <div class="col-md-10">
                                    <input type="date" value="<?= $beasiswa_>tanggal_selesai ?> name="tanggal_selesai" required class="form-control">
                            </div>
                            </div>
                            <div class="form-group row">
